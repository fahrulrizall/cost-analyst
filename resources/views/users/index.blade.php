            ...
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle"
                     src="/adminlte/dist/img/users/{{$user->avatar}}"
                     alt="User profile picture">
              </div>
              
              <h3 class="profile-username text-center">{{$user->name}}</h3>

              <p class="text-muted text-center">{{$user->departement}} - {{$user->position}}</p>
              <hr>
              ...
              <p class="text-muted">
                <p class="text-muted">mampos</p>
              </p>
              
              <hr>
              <a href="/siswa/adaaa" class="btn btn-primary btn-block formProfile" data-toggle="modal" data-target="#modal-default" data-id="{{$user->id}}"><b>Edit</b></a>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <select class="custom-select" id="departemen" name="departement" value="">
                  <option>Cost & Inventory Control</option>
            ...
            <div class="form-group">
              <label>Position</label>
                <select class="custom-select" id="position" name="position" value="">
            ...
            <div class="form-group">
                ...
                name="education" placeholder="Education" value="">
                @error('education')
                    <div class="invalid-feedback">{{$message}}</div> 
                @enderror
            </div>
            <div class="form-group">
            <label for="education">Avatar</label>
                <div class="custom-file">
                  <input type="file" class="custom-file-input @error('avatar') is-invalid @enderror" id="avatar"
                   name="avatar" accept="image/jpeg,image/jpg,image/png">
