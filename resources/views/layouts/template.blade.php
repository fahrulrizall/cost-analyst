  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="/adminlte/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Anova</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/fgs/{{3770}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Finished Goods</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/macs/{{3770}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Moving Average Cost</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/pts/{{3770}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Productions Target</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/packagings/{{3770}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Packaging</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/fgs/{{3710}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Finished Goods</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/macs/{{3710}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Moving Average Cost</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/pts/{{3710}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Productions Target</p>
                </a>
              </li>
